...
public class UberMinerItems {
    ...
    public static final RegistryObject<Item> UBER_MINER_TIER_1 = ITEMS.register("uber_miner_tier1",
            () -> new BlockItem(UberMinerBlocks.UBER_MINER_TIER_1.get(),
                    new Item.Properties().stacksTo(1).tab(UberMiner.UBER_MINER_TAB)));
